...
<?php 
  ...
  function berechnungRoemisch(){      // Berechnung der Aufgabe
  
  $eingabeZahl = $_POST['inputZahl']; // Eingabezahl als Veriable 
  ...
  echo $eingabeZahl;
  echo " ist in römischen Zahlen: ";
  if($eingabeZahl>3000 || $eingabeZahl < 1){
